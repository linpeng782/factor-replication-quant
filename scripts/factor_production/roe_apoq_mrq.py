"""
因子: roe_apoq_mrq — 单季度 ROE 环比（绝对值版，不过滤）

定义：roe_mrq_0 = net_profit_mrq_0 / total_equity_mrq_0
      roe_mrq_1 = net_profit_mrq_1 / total_equity_mrq_1
      因子 = (roe_mrq_0 - roe_mrq_1) / abs(roe_mrq_1)
方向：正向；分类：景气
"""
...
def main():
    ...
    factor.to_parquet("roe_apoq_mrq.parquet")
