...
约定:
    ...
    因子产出:    factors/{raw,cleaned,neu}/<source>/<group>/<FACTOR>.parquet（namespace=source/group 由 spec 路径推导）
    评估输出:    output/<source>/<group>/<FACTOR>/evaluation_<range>__{cleaned,neu}.png
"""
